...
using App.Modules.Accounts.Infrastructure.Domain.Accounts.AccountViewMetadata;
...
public class AccountsContext : DbContext
{
    ...
    public DbSet<AccountViewMetadata>? AccountViewMetadata { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new AccountViewMetadataEntityTypeConfiguration());
