...
namespace App.Modules.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20230625075905_AddInvestmentPortfolios")]
    partial class AddInvestmentPortfolios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Modules.Accounts.Domain.Investments.InvestmentPortfolios.InvestmentPortfolio", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("investment_portfolios", "accounts");
                });
            ...
            modelBuilder.Entity("App.Modules.Accounts.Domain.Investments.InvestmentPortfolios.InvestmentPortfolio", b =>
                {
                    b.OwnsOne("App.Modules.Accounts.Domain.Accounts.Currency", "_currency", b1 =>
                        {
                            b1.Property<Guid>("InvestmentPortfolioId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("InvestmentPortfolioId");

                            b1.ToTable("investment_portfolios", "accounts");
