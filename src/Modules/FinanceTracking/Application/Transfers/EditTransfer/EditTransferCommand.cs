...
public class EditTransferCommand(Guid transferId, Guid sourceWalletId, Guid targetWalletId, int amount, string currency, DateTime madeOn, string? comment, IEnumerable<string>? tags) : CommandBase
{
