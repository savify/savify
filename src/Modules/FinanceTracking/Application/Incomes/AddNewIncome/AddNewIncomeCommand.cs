...
public class AddNewIncomeCommand(Guid userId, Guid targetWalletId, Guid categoryId, int amount, string currency, DateTime madeOn, string? comment, IEnumerable<string>? tags)
    : CommandBase<Guid>
{
