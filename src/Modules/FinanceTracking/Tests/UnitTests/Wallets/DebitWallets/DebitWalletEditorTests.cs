...
[TestFixture]
public class DebitWalletEditorTests : UnitTestBase
{
    [Test]
    public async Task EditWallet_WhenWalletExists_ShouldEditWallet()
    {
        ...
        var debitWalletEditingService = new DebitWalletEditor(debitWalletRepository, walletViewMetadataRepository);
