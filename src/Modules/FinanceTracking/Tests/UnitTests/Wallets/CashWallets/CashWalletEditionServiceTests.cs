...
[TestFixture]
public class CashWalletEditionServiceTests : UnitTestBase
{
    [Test]
    public async Task EditWallet_WhenWalletExists_ShouldEditWallet()
    {
        ...
        var cashWalletEditingService = new CashWalletEditionService(cashWalletRepository, walletViewMetadataRepository);
