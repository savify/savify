...
public class TransferAddedDomainEvent(TransferId transferId, WalletId sourceWalletId, WalletId targetWalletId, Money amount, DateTime madeOn, string comment, IEnumerable<string> tags) : DomainEventBase
{
