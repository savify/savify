...
public class CreditWalletEditingService
{
    ...
    public CreditWalletEditingService(ICreditWalletRepository creditWalletRepository, IWalletViewMetadataRepository walletViewMetadataRepository)
    {
