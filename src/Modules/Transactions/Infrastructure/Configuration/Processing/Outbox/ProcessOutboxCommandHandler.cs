...
public class ProcessOutboxCommandHandler : ICommandHandler<ProcessOutboxCommand>
{
    ...
    private readonly IDomainNotificationsMapper<TransactionsContext> _domainNotificationsMapper;
    ...
    public ProcessOutboxCommandHandler(
        ...
        IDomainNotificationsMapper<TransactionsContext> domainNotificationsMapper,
        ILogger logger)
    {
        _mediator = mediator;
    ...
    public async Task Handle(ProcessOutboxCommand command, CancellationToken cancellationToken)
    {
        ...
        string sql = "SELECT " +
                  ...
                  "FROM transactions.outbox_messages AS message " +
        ...
        const string sqlUpdateProcessedDate = "UPDATE transactions.outbox_messages " +
